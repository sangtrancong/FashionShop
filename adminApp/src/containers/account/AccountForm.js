            ...
            <div className="card card-primary">
              ...
              <div className="card-body">
                <div class="row">
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => handleChangeValue(e)}
                      />
                      <span id="inputUsername-error" class="error invalid-feedback">{t(messages?.username) || ''}</span>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        onChange={(e) => handleChangeValue(e)}
                      />
                      <span id="inputPhone-error" class="error invalid-feedback">{t(messages?.phone) || ''}</span>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <label htmlFor="inputRoleName">Vai Trò</label>
                      <select
                        id="inputRoleName"
                        name="roleName"
                        className="form-control custom-select"
                        value={allValues?.role?.name}
                        onChange={(e) => handleChangeValue(e)}
                      >
