...
import { fetchAllData, clearSelectedItem } from "../../redux/categorySlice";
                        ...
                        allData.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td className="project-actions text-center">
                              <Link to={`/webadmin/category/form/${item.id}`} className="btn btn-info btn-sm mr-1">
