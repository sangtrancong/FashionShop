...
const OrderForm = () => {
  ...
  const handleSubmit = (e) => {
    const params = {
      id: id || 0,
      shipperId: allValues.shipperId || 0,
            ...
            <div className="card card-primary">
              ...
              <div className="card-body">
                <div class="row">
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <label htmlFor="inputProgress">Tình Trạng Đơn Hàng</label>
                      <input
                        id="inputProgress"
                        name="progress"
                        type="text"
                        className={`${messages?.progress ? 'form-control is-invalid' : 'form-control'}`}
                        value={allValues?.progress}
                        onChange={(e) => handleChangeValue(e)}
                        disabled
                      />
                      <span id="inputProgress-error" class="error invalid-feedback">{messages?.progress || ''}</span>
                    </div>
                  </div>
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      ...
                      <input
                        ...
                        value={`${allValues?.account?.fullname} - ${allValues?.account?.email}`}
                        onChange={(e) => handleChangeValue(e)}
                        disabled
                      />
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <label htmlFor="inputTotalCost">Tổng Tiền (VNĐ)</label>
                      <input
                        id="inputTotalCost"
                        name="totalCost"
                        type="text"
                        className={`${messages?.totalCost ? 'form-control is-invalid' : 'form-control'}`}
                        value={allValues?.totalCost?.toLocaleString('en-US') || 0}
                        onChange={(e) => handleChangeValue(e)}
                        disabled
                      />
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <label htmlFor="inputPromotion">Mã Giảm Giá</label>
                      <input
                        id="inputPromotion"
                        name="promotion"
                        type="text"
                        className={`${messages?.promotion ? 'form-control is-invalid' : 'form-control'}`}
                        value={allValues?.promotion?.name? `${allValues?.promotion?.name} - ${allValues?.promotion?.code} - ${allValues?.promotion?.couponAmount} (${allValues?.promotion?.couponType})`: ''}
                        onChange={(e) => handleChangeValue(e)}
                        disabled
                      />
                      <span id="inputPromotion-error" class="error invalid-feedback">{messages?.promotion || ''}</span>
                    </div>
                  </div>
