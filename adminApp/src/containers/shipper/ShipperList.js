...
import { fetchAllDataShipper, clearSelectedItem } from "../../redux/accountSlice";
...
const ShipperList = () => {
  ...
  useEffect(() => {
    dispatch(fetchAllDataShipper()).then(() => {
                        ...
                        allData.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td className="project-actions text-center">
                              <Link to={`/webadmin/account/shipper/form/${item.id}`} className="btn btn-info btn-sm mr-1">
