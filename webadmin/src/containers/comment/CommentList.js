...
import { fetchAllData, clearSelectedItem} from "../../redux/commentSlice";
              ...
              <div className="card">
                <div className="card-header">
                  ...
                  {/* <div className="card-tools">
                    <a type="button" className="btn btn-block btn-primary" href="/masterdata/brands/form">Thêm Mới</a>
                  </div> */}
                </div>
                        ...
                        allData?.map((item, index) => (
                          <tr key={index}>
                            ...
                            <td className="project-actions text-center">
                              <Link to={`/webadmin/comment/form/${item.id}`} className="btn btn-info btn-sm mr-1">
